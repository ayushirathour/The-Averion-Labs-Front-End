...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-primary-600 text-primary-600 hover:bg-primary-50 dark:hover:bg-gray-700 focus:ring-primary-500',
    ghost: 'text-primary-600 hover:bg-primary-50 dark:hover:bg-gray-700 focus:ring-primary-500',
